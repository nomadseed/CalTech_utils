...
create TFrecord file of CalTech Pedestrian dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_label',type=str, default='caltech_annotation_VIVA_debug.json',
    ...
    labelpath=os.path.join(filepath,'annotations')
